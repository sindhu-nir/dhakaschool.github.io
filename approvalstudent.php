            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-offset-3 col-lg-6 col-lg-offset-3">
                        ...
                        <form name="form" method="post" action="approvalstudent.php">
                           ...
                           <div class="form-group">
							...
							mysql_select_db("schoolmanagement", $con); 
								...
								$result = mysql_query("SELECT RollNo FROM student where approve='false'") 
							or die(mysql_error()); 
							...
							echo '<select name="id" required class="form-control"><option value="">select..</option>'; 
							...
							echo '</select>'; 
							 ...
							 <div class="form-group">
							 <label>Status  </label>
                               <select name="Student_approval" required class="form-control">
...
echo "<script> alert ('Student  $a Does not EXISTS ');</script>";
  }

else{
$sql="UPDATE student SET `approve` = '$b' WHERE `RollNo` = '$a'";
...
<?php
 ...
 $result = $con->query("SELECT * FROM student where approve='false'");
