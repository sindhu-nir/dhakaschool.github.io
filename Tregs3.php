                ...
                <div class="row">
                    ...
                    <div class="col-lg-offset-3 col-lg-6 col-lg-offset-3">
								...
								mysqli_select_db($con,"schoolmanagement");
									...
									$sql1 ="SELECT * FROM teacher where Day='$d' and Initial='$a'";
									
									$sql2="SELECT `$e` FROM schedule where Day='$d' and Class='$c'";
									$result1 = $con->query($sql1);
									$result2 = $con->query($sql2);
									
								 if ($result1->num_rows == 0) {	  

							   mysqli_query($con,"INSERT INTO teacher (Initial,Day,`$e`) VALUES ('$a', '$d','$b($c)')");
							   echo "<script> alert ('Course Add Successfull in teacher Table ');</script>";
							
								 }
								  else{
								    mysqli_query($con,"Update teacher Set `$e`='$b($c)' where Initial='$a' and Day='$d'");
									 echo "<script> alert ('Course update Successfull in teacher Table ');</script>";
							  }
							  
							 	 if ($result2->num_rows == 0) {
							  	  

							   mysqli_query($con,"INSERT INTO schedule (Class,Day,`$e`) VALUES ('$c', '$d','$b($a)')");
							   echo "<script> alert ('Course Add Successfull in Schedule Table ');</script>";
							
							  }
							   else{
								    mysqli_query($con,"Update schedule Set `$e`='$b($a)' where Class='$c' and Day='$d'");
									 echo "<script> alert ('Course update Successfull in schedule Table ');</script>";
							  }
