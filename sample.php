    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="teacher.php">SB Teacher</a>
            </div>
            <!-- Top Menu Items -->
...
<b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li >
                        <a href="teacher.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li >
                        <a href="Tschedule.php"><i class="fa fa-fw fa-bar-chart-o"></i>Check Routine</a>
                    </li>
                    <li class="active">
                        <a href="mark.php"><i class="fa fa-fw fa-table"></i> Student Mark Add </a>
                    </li>
                    <li>
                        <a href="Tupdate1.php"><i class="fa fa-fw fa-edit"></i> Update Info</a>
                    </li>
                    <li>
                        <a href="Tprofile.php"><i class="fa fa-fw fa-desktop"></i> My Profile</a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> student mark
                            </li>
                        </ol>
                    </div>
                </div>
...
<br><br>
        ...
        $result = mysql_query("SELECT distinct course FROM courses where Initial='RH'") 
        or die(mysql_error());   
         
         
         
        echo '<select name="Options"><option value=""></option>'; 
