...
<br><br>
                ...
                <div class="row">
							...
							<form name="f1" method="post"  action="mark2.php" onsubmit="return validateForm() ">
							...
							mysql_select_db("schoolmanagement", $con); 
								...
								$result = mysql_query("SELECT Class FROM courses where Initial='$initial' and course='$course'") 
							or die(mysql_error()); 
							...
							echo '<select name="class" required class="form-control"><option value="">select..</option>'; 
