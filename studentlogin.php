...
<div id="page">
  <div id="header">
    ...
    <ul>
      ...
      <li class="current"><a href="studentlogin.php">Student Info</a></li>
	...
	<br><br><br><br><br><br>
		...
		<form name='myForm' method='post' action='logins.php' onsubmit="return validateForm()" >
...
<tr>
<td colspan=2>
<center><font size=4><b>Student Login Form</b></font></center>
<br><br>
</td>
</tr>
...
<p align="center">
 New User ? <br> <br> <br>
 <a href="studentReg.php"> Register here  </a> </p>
</body>
</html>
