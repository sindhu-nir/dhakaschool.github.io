            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-offset-3 col-lg-6 col-lg-offset-3">
                        ...
                        <form name="f1" method='post' action='Tregs3.php' onsubmit="return validateForm()">
                      ...
                      <div class="form-group">
						 ...
						 $con = mysql_connect("localhost","root",""); 
							...
							mysql_select_db("schoolmanagement", $con); 
							 $result = mysql_query("SELECT * FROM courses where Initial='$initial'") 
							or die(mysql_error());  

								 $result1 = mysql_query("SELECT  Class FROM courses where Initial='$initial' and course='$course'") 
							or die(mysql_error());
							...
							echo '<label> Class :</label><select name="Class" required class="form-control"><option value="">select..</option>'; 
						
							while($row = mysql_fetch_array($result1)) 
							{ 
							echo '<option value="'.$row['Class'].'">'. stripslashes($row['Class']). '</option>'; 
							 ...
							 <div class="form-group">
								...
								<option value='' selected>select..</option>
									<option value='time1'> 9:00-10:00</option>
										...
										<option value='time4'>11:30-12:30</option>
										<option value='time5'>12:30-01:30</option>
